...
<div style='text-align:center;font-size:12px;'><hr/><a href='https://github.com/softypit/esp32_mqtt_eq3' target='_blank' style='color:#aaa;'>EQ3-MQTT-ESP32
)EOF" ;

const char pagefooter2[] = " "EQ3_MAJVER"."EQ3_MINVER""EQ3_EXTRAVER" ";

const char pagefooter3[] = R"EOF(
by SoftyPIT</a><br/>
